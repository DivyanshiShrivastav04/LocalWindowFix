...
function initScrollAnimations() {
    ...
    const elementsToAnimate = document.querySelectorAll('.service-card, .testimonial-card, .faq-item, .about-content > *, .contact-content > *');
...
if (window.location.pathname.includes('.html') && !window.location.pathname.includes('index.html')) {
    document.addEventListener('DOMContentLoaded', function() {
        // Add back to top button for service pages
